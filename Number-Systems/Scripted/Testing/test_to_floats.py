...
from floats.to_float import convert_rational
...
class Test_Rational_Numbers(unittest.TestCase):
   def test_convert_rational(self):
      ...
      """
      self.assertEqual(convert_rational(base= 2)("0.3"), "0.01001")
      self.assertEqual(convert_rational(base= 2)("12.3"), "1100.01001")
      self.assertEqual(convert_rational(base= 3)("50.5"), "1212.1")
      ...
      self.assertEqual(convert_rational(base= 7)("37.3"), "52.2046")
      self.assertEqual(convert_rational(base= 8)("101.75"), "145.6")
      self.assertEqual(convert_rational(base= 9)("111.3"), "133.26")
      self.assertEqual(convert_rational(base=11)("151.4"), "128.4")
      self.assertEqual(convert_rational(base=12)("47.875"), "3B.A6")
      self.assertEqual(convert_rational(base=13)("47.875"), "38.B4")
      self.assertEqual(convert_rational(base=14)("47.875"), "35.C37")
      self.assertEqual(convert_rational(base=15)("41.875"), "2B.D1")
